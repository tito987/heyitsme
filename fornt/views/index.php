    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto my-2 my-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#services">Professionels</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="#contact">Contact</a>
		     ...
		     <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="profile.php">Mon espace</a>
          </li>
           <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="deconnexion.php">Se Deconnecter</a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="container h-100">
      <div class="row h-100 align-items-center justify-content-center text-center">
        ...
        <div class="col-lg-8 align-self-baseline">
          <p class="text-white-75 font-weight-light mb-5">Parceque 1,3 milliard de tonnes d'aliments sont gaspillés par an, 41,2 tonnes jetées chaque seconde et un tiers de la production alimentaire mondiale gaspillées: agissez avec nous.</p>
