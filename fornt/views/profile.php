...
<div class="container mt-5">
    <div class="row">
            ...
            <div class="author-card pb-3">
                ...
                <div class="author-card-profile">
                    ...
                    <div class="author-card-details">
                        <h5 class="author-card-name text-lg" ><?php echo $_SESSION['login']; ?></h5><span class="author-card-position">inscrit le  <?php echo $_SESSION['dateinscri']; ?></span>
                    </div>
                </div>
            </div>
            <div class="wizard">
                <nav class="list-group list-group-flush">
                    <a class="list-group-item" href="deconnexion.php">
                        <div class="d-flex justify-content-between align-items-center">
                            <div><i class="fe-icon-shopping-bag mr-1 text-muted"></i>
                               <left> <div class="d-inline-block font-weight-medium text-uppercase">Se Déconnecter</div></left>
                            </div>
                        </div>
                    </a><a class="list-group-item active" href="#"><i class="fe-icon-user text-muted"></i>Parmétres Génerales</a><a class="list-group-item" href="desactive.php"><i class="fe-icon-map-pin text-muted"></i>Désactiver Votre compte</a>
                    <a class="list-group-item" href="sondage1.php">
                        <div class="d-flex justify-content-between align-items-center">
                            <div><i class="fe-icon-heart mr-1 text-muted"></i>
                                <div class="d-inline-block font-weight-medium text-uppercase">Supprimer Compte</div>
        ...
        <div class="col-lg-8 pb-5">
            <form class="row" method="post" action="modifierclient.php">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="account-fn">Prénom</label>
                        <input class="form-control" type="text" id="account-fn" name="prenom" value="<?php echo $_SESSION['prenom']; ?>"  required="">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="account-ln">Nom</label>
                        <input class="form-control" type="text" id="account-ln" name="nom"value="<?php echo $_SESSION['nom']; ?> " required="">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="account-email">Login</label>
                        <input class="form-control" type="text" id="account-email" name="log" value="<?php echo $_SESSION['login']; ?> "  >
                    </div>
                </div>
                  <div class="col-md-6">
                    <div class="form-group">
                        <label >Numero de telephone</label>
                        <input class="form-control" type="text" id="numtel" nom="numtel" value="<?php echo $_SESSION['numerotel']; ?>" >
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="password"  name="motdepasse2">
                    </div>
                </div>
                <div class="col-12">
                    <hr class="mt-2 mb-3">
                    <div class="d-flex flex-wrap justify-content-between align-items-center">
                        <button class="btn btn-style-1 btn-primary" >Mettre à Jour <button>
                    </div>
                </div>
            </form>
        </div>
