...
<head>
    ...
    function delayedRedirect(){
        window.location = "supremeauthentic.php"
    }
    </script>
...
<?php
$rating_input_1   = $_POST['rating_input_1'];
$rating_input_2    = $_POST['rating_input_2'];
$rating_input_3  = $_POST['rating_input_3'];
...
$mail->Subject = "Review from MAVIA";

//Enter the content of your email message:
$mail->Message = "DETAILS:\n
Service provided: $rating_input_1
Product's quality: $rating_input_2
Support: $rating_input_3
Review: $review
\nUSER DETAILS:
Email: $email
...
if (!$mail->Send())
	{
	$response = "Mailer Error: please contact support@mavia.com " ;
	}
  else
	{
