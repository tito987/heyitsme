      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="buttons.html">Affichier liste Adminstrateurs</a>
            <a class="collapse-item" href="cards.html">Ajouter Adminstrateurs</a>
          </div>
        </div>
      </li>
...
function drawChart() {
 ...
 ['Homme',     <?php echo $male; ?>],
  ...
  var options = {'title':'Repartition par Sexe', 'width':550, 'height':400};
