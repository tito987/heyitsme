  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $_SESSION['l']; ?> </span>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Liste des Adminstrateurs</h6>
            </div>
            <div class="card-body">
        ...
        <td><input type="text" name="login" value="<?php echo $val['Login']?>"></td> 
        <td><input type="text" name="mdp" value="<?php echo $val['motdepasse']?>"></td> 
      </tr>
     <?php   } ?>
                  </tbody>
				  </table>
	    	  <button class="btn btn-primary pull-right" type="submit"  data-background-color="blue">Modifier</button>
    
    
              <a href="afficheradmin.php"class="btn btn-primary pull-right"  data-background-color="blue">Retour</a>
