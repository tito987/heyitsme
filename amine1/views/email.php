...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="pageaccueil.php">
      ...
      <a class="collapse-item" href="statistiques.php">Statistique</a>
       <a class="collapse-item" href="statistiques.php">Envoie E-mail!</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
                   <form  enctype="multipart/form-data" method="post" action="mmail.php"><center> 
                               <p>Adresse Mail <input type="email" name="adresse" class="form-control bg-light border-0 small" /></p> 
                               <p>Message<br /><textarea name="message" rows="10" cols="50" class="form-control bg-light border-0 small" ></textarea></p> 
                               <input type="hidden" name="MAX_FILE_SIZE" value="2097152"> 
                               <p>Choisissez un fichiers avec une taille inférieure à 2 Mo.</p> 
